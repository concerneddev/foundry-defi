 ...
 * @author Nimish Thule
 *
 * This system is designed to be as minimal as possible, and have the tokens maintain  a 1USD Token == 1USD PEG.
 *
 ...
 *
 * Our DSC system should always be overcollateralised. At no point, should the value of all collateral <= value of all DSC.
 *
...
contract DSCEngine is ReentrancyGuard {
     ...
     * @notice This token will deposit collateral and mint DSC in one txn.
     */
     ...
     * @param amountDscToMint The amount of DSC token to be minted
    ...
    /**
     * @dev Low-level internal function, do not call it unless the function calling it is
    ...
    function _getAccountInformation(address user)
        private
        view
        returns (uint256 totalDscMinted, uint256 collateralBalanceInUsd)
    {
        totalDscMinted = s_DSCMinted[user];
        collateralBalanceInUsd = getAccountCollateralValue(user);
    }
    ...
    // calculates the amount of a specific token a user can receive for a given USD amount.
